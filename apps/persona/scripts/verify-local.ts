...
const steps: Step[] = [
  ...
  {
    name: "Project lifecycle and Todo relationship contract test",
    command: "npm.cmd run contract:projects",
  },
  {
    name: "Persisted and audited Working State contract test",
...
function runRootStructureCheck(): void {
  ...
  const requiredFiles = [
    ...
    "apps/persona/src/domain/conversation-job/history.ts",
    "apps/persona/src/domain/todo/store.ts",
    "apps/persona/src/domain/todo/validation.ts",
    "apps/persona/src/domain/project/store.ts",
    ...
    "apps/persona/src/infra/db/project-todo-migration.ts",
